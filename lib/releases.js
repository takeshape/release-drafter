...
module.exports.updateRelease = ({ context, draftRelease, releaseInfo }) => {
  const updateReleaseParams = updateDraftReleaseParams({
    ...
    target_commitish: releaseInfo.targetCommitish || draftRelease.target_commitish,
  })
...
function updateDraftReleaseParams(params) {
  ...
  if (!updateReleaseParams.target_commitish) {
    delete updateReleaseParams.target_commitish
  }  
